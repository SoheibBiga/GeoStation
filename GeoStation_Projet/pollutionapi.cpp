...
PollutionApi::PollutionApi(ordonnanceur *ord_, QObject *parent) : AbstractApi(ord_, parent)
{
    ...
    QString latitude = "48.866667";
    latitude.toDouble();
    QString longitude = "2.333333";
    longitude.toDouble();

    manager->get(QNetworkRequest(QUrl("https://api.waqi.info/feed/geo:"+latitude+";"+longitude+"/?token=1427ed34fa11aff3521e1967be850e08e1df97cb")));
