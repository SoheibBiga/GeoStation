    ...
    ui(new Ui::SatelliteMozaicWidget)
{
    ...
    ui->Name->setStyleSheet("background-color: rgba(0,0,0,0%)");
    ui->label_3->setStyleSheet("background-color: rgba(0,0,0,0%)");
    ui->label_4->setStyleSheet("background-color: rgba(0,0,0,0%)");
    ui->label_5->setStyleSheet("background-color: rgba(0,0,0,0%)");
